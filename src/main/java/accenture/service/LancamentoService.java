...
public class LancamentoService {
	...
	public LancamentoDTO CadastrarLancamento(LancamentoDTO lancamentoDTO) {
		...
		if(planoContaBuscado.isPresent() == false) throw new RecursoNaoEncontrado("Plano de conta não enontradp");
		...
		// Persistindo Lancamento no banco de daos
	...
	private void realizarLancamentoDespesa(Lancamento lancamento){
		...
		if(conta.getSaldo() - lancamento.getValor() < 0){
	...
	private void realizarLancamentoTransferenciaConta(Lancamento lancamento){
		...
		if (contaOrigem.getSaldo() - lancamento.getValor() < 0){
